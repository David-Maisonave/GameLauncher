...
{
    public partial class Form_GameSystemEditor : Form
    {
        public GameSystem gameSystem { get; private set; }
        public bool Ok { get; private set; } = false;
        public Form_GameSystemEditor(GameSystem gameSystem)
        {
            ...
            if (gameSystem.Initiated)
            {
                checkBox_ExtractArchive1.Checked  = gameSystem.DecompressFile[0];
                checkBox_ExtractArchive2.Checked  = gameSystem.DecompressFile[1];
                checkBox_ExtractArchive3.Checked  = gameSystem.DecompressFile[2];
                checkBox_ExtractArchive4.Checked  = gameSystem.DecompressFile[3];
                checkBox_ExtractArchive5.Checked  = gameSystem.DecompressFile[4];
                checkBox_ExtractArchive6.Checked  = gameSystem.DecompressFile[5];
                checkBox_ExtractArchive7.Checked  = gameSystem.DecompressFile[6];
                checkBox_ExtractArchive8.Checked  = gameSystem.DecompressFile[7];
                checkBox_ExtractArchive9.Checked  = gameSystem.DecompressFile[8];
                checkBox_ExtractArchive10.Checked = gameSystem.DecompressFile[9];
            }
            else
            {
                checkBox_ExtractArchive1.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[0], gameSystem.DecompressFile[0] ? 1 : 0);
                checkBox_ExtractArchive2.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[1], gameSystem.DecompressFile[1] ? 1 : 0);
                checkBox_ExtractArchive3.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[2], gameSystem.DecompressFile[2] ? 1 : 0);
                checkBox_ExtractArchive4.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[3], gameSystem.DecompressFile[3] ? 1 : 0);
                checkBox_ExtractArchive5.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[4], gameSystem.DecompressFile[4] ? 1 : 0);
                checkBox_ExtractArchive6.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[5], gameSystem.DecompressFile[5] ? 1 : 0);
                checkBox_ExtractArchive7.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[6], gameSystem.DecompressFile[6] ? 1 : 0);
                checkBox_ExtractArchive8.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[7], gameSystem.DecompressFile[7] ? 1 : 0);
                checkBox_ExtractArchive9.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[8], gameSystem.DecompressFile[8] ? 1 : 0);
                checkBox_ExtractArchive10.Checked = Form_Main.EmulatorRequiresDecompression(gameSystem.EmulatorPaths[9], gameSystem.DecompressFile[9] ? 1 : 0);
            }
        ...
        private void button_Ok_Click(object sender, EventArgs e)
        {
            ...
            gameSystem.DecompressFile[0] = checkBox_ExtractArchive1.Checked;
            gameSystem.DecompressFile[1] = checkBox_ExtractArchive2.Checked;
            gameSystem.DecompressFile[2] = checkBox_ExtractArchive3.Checked;
            gameSystem.DecompressFile[3] = checkBox_ExtractArchive4.Checked;
            gameSystem.DecompressFile[4] = checkBox_ExtractArchive5.Checked;
            gameSystem.DecompressFile[5] = checkBox_ExtractArchive6.Checked;
            gameSystem.DecompressFile[6] = checkBox_ExtractArchive7.Checked;
            gameSystem.DecompressFile[7] = checkBox_ExtractArchive8.Checked;
            gameSystem.DecompressFile[8] = checkBox_ExtractArchive9.Checked;
            gameSystem.DecompressFile[9] = checkBox_ExtractArchive10.Checked;
