...
* [1.0.0] Add pagination to game console systems having over 1500 ROM's.
* [1.0.0] Add option to advance menu to compress all ROM files to zip.
* [1.0.0] Add option to Settings to allow changing default **images** and **roms** sub folder.
* [1.0.0] Add option to view preview/play image over box-art image.
